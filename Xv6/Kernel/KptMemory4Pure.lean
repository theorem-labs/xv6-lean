import Xv6.Kernel.KptMemory4Spec
...
theorem transform shares rs data root (ambient : Ambient rs)
  ...
  KptMemory.transform shares rs data root ambient rooted va kind
...
theorem completed rs data root kind va ppn outcome (ambient : Ambient rs)
  ...
  KptMemory.completed rs data root kind va ppn outcome ambient positive facts
