...
theorem remainder_s1 (s : Shares) : remainderFootprint s .s1 =
    [(.PC, .own 1), (.nextPC, .own 1), (.minstret, .own 1), (.minstret_increment, .own 1), (.mcountinhibit, .discard), (.minstretcfg, .discard), (.mcycle, .own 1), (.mtime, .own 1), (.mip, .own 1), (.misa, s.misa), (.mie, s.enable), (.mideleg, s.delegation), (.elp, s.landing), (.hart_state, s.hart), (.x1, .own 1), (.x3, .own 1), (.x4, .own 1), (.x5, .own 1), (.x6, .own 1), (.x7, .own 1), (.x8, .own 1), (.x10, .own 1), (.x11, .own 1), (.x12, .own 1), (.x13, .own 1), (.x14, .own 1), (.x15, .own 1), (.x16, .own 1), (.x17, .own 1), (.x18, .own 1), (.x19, .own 1), (.x20, .own 1), (.x21, .own 1), (.x22, .own 1), (.x23, .own 1), (.x24, .own 1), (.x25, .own 1), (.x26, .own 1), (.x27, .own 1), (.x28, .own 1), (.x29, .own 1), (.x30, .own 1), (.x31, .own 1)] := rfl
...
theorem cells_partition (era : Era.Record) (cpu : CPU) (rs : RegisterFile) s slot :
  ...
  cases slot <;>
    simp only [remainder_ra, remainder_s0, remainder_s1, MycpuRegimeShell.footprint, MycpuRegimeShell.controlFootprint,
      ...
      MycpuOff.gpr_list, footprint, memoryShares, MycpuKptMemory.memoryShares, KptAddress.auxiliaryFootprint,
      register, List.cons_append, List.nil_append, RegisterFootprint.cells]
  · constructor
  ...
  · constructor
    · iintro ⟨HPC, HnextPC, Hminstret, Hminstret_increment, Hmcountinhibit, Hminstretcfg, Hmcycle, Hmtime, Hmip, Hcur_privilege, Hmisa, Hmie, Hmideleg, Hmenvcfg, Help, Hpma_regions, Hhtif_tohost_base, Hhart_state, Hmstatus, Hx1, Hx2, Hx3, Hx4, Hx5, Hx6, Hx7, Hx8, Hx9, Hx10, Hx11, Hx12, Hx13, Hx14, Hx15, Hx16, Hx17, Hx18, Hx19, Hx20, Hx21, Hx22, Hx23, Hx24, Hx25, Hx26, Hx27, Hx28, Hx29, Hx30, Hx31, _⟩
      iframe
    · iintro ⟨⟨Hmstatus, Hcur_privilege, Hpma_regions, Hhtif_tohost_base, Hmenvcfg, Hx2, Hx9, _⟩, ⟨HPC, HnextPC, Hminstret, Hminstret_increment, Hmcountinhibit, Hminstretcfg, Hmcycle, Hmtime, Hmip, Hmisa, Hmie, Hmideleg, Help, Hhart_state, Hx1, Hx3, Hx4, Hx5, Hx6, Hx7, Hx8, Hx10, Hx11, Hx12, Hx13, Hx14, Hx15, Hx16, Hx17, Hx18, Hx19, Hx20, Hx21, Hx22, Hx23, Hx24, Hx25, Hx26, Hx27, Hx28, Hx29, Hx30, Hx31, _⟩⟩
      iframe
...
theorem packet_frame_load era cpu control values shares slot word :
  ...
  cases slot <;> unfold physicalAfter
  all_goals rw [RegisterFootprint.cells_write_other]
  all_goals simp [remainder_ra, remainder_s0, remainder_s1]
