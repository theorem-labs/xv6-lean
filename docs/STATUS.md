...
| Reproducible repository/tooling | Implemented; CI pending | Build, imports, image decoding and source regeneration pass |
...
| Sail free V1 event interface | In progress | sail_audit, isolated dependency checkout |
