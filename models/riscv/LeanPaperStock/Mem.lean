...
import LeanPaperStock.MemMetadata
...
import LeanPaperStock.MemTypeUtils
...
/-- Type quantifiers: k_ex680598_ : Bool, k_ex680597_ : Bool, k_ex680596_ : Bool -/
...
/-- Type quantifiers: k_ex680604_ : Bool, k_ex680603_ : Bool, k_ex680602_ : Bool -/
...
/-- Type quantifiers: k_ex680610_ : Bool, width : Nat, 0 < width ∧ width ≤ max_mem_access -/
  ...
  let canAccess ← (( do
    ...
    | .Load .Vector =>
      (do
        ...
        (pure attributes.readable))
    | .Load .PageTableEntry => (pure attributes.supports_pte_read)
    | .Store .Data =>
      (do
    ...
    | .Store .Vector =>
      (do
        ...
        (pure attributes.writable))
    | .Store .PageTableEntry => (pure attributes.supports_pte_write)
...
/-- Type quantifiers: k_ex680711_ : Bool, width : Nat, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex680713_ : Bool, width : Nat, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex680718_ : Bool, k_ex680717_ : Bool, k_ex680716_ : Bool, k_ex680715_ : Bool, width
...
/-- Type quantifiers: k_ex680750_ : Bool, k_ex680749_ : Bool, k_ex680748_ : Bool, k_ex680747_ : Bool, width
  : Nat, width ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex680784_ : Bool, k_ex680783_ : Bool, k_ex680782_ : Bool, k_ex680781_ : Bool, width
  : Nat, width ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex680787_ : Bool, k_ex680786_ : Bool, k_ex680785_ : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex680790_ : Bool, k_ex680789_ : Bool, k_ex680788_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex680793_ : Bool, k_ex680792_ : Bool, k_ex680791_ : Bool, width : Nat, 0 <
...
/-- Type quantifiers: k_ex680820_ : Bool, k_ex680819_ : Bool, k_ex680818_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex680862_ : Bool, k_ex680861_ : Bool, k_ex680860_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex680866_ : Bool, k_ex680865_ : Bool, k_ex680864_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex680869_ : Bool, k_ex680868_ : Bool, k_ex680867_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex680872_ : Bool, k_ex680871_ : Bool, k_ex680870_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
