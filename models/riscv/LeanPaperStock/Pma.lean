...
import LeanPaperStock.RangeUtil
import LeanPaperStock.VmemTypes
import LeanPaperStock.MemUtils
...
/-- Type quantifiers: k_ex680549_ : Bool -/
...
/-- Type quantifiers: k_ex680555_ : Bool, width : Nat, 0 < width ∧ width ≤ max_mem_access -/
