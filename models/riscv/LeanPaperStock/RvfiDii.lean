...
def print_rvfi_exec (_ : Unit) : SailM Unit := do
  let snapshot0 ← readReg rvfi_inst_data
  let _ := print_bits "rvfi_intr     : " (_get_RVFI_DII_Execution_Packet_InstMetaData_rvfi_intr snapshot0)
  let snapshot1 ← readReg rvfi_inst_data
  let _ := print_bits "rvfi_halt     : " (_get_RVFI_DII_Execution_Packet_InstMetaData_rvfi_halt snapshot1)
  let snapshot2 ← readReg rvfi_inst_data
  let _ := print_bits "rvfi_trap     : " (_get_RVFI_DII_Execution_Packet_InstMetaData_rvfi_trap snapshot2)
  let snapshot3 ← readReg rvfi_int_data
  let _ := print_bits "rvfi_rd_addr  : " (_get_RVFI_DII_Execution_Packet_Ext_Integer_rvfi_rd_addr snapshot3)
  let snapshot4 ← readReg rvfi_int_data
  let _ := print_bits "rvfi_rs2_addr : " (_get_RVFI_DII_Execution_Packet_Ext_Integer_rvfi_rs2_addr snapshot4)
  let snapshot5 ← readReg rvfi_int_data
  let _ := print_bits "rvfi_rs1_addr : " (_get_RVFI_DII_Execution_Packet_Ext_Integer_rvfi_rs1_addr snapshot5)
  let snapshot6 ← readReg rvfi_mem_data
  let _ := print_bits "rvfi_mem_wmask: " (_get_RVFI_DII_Execution_Packet_Ext_MemAccess_rvfi_mem_wmask snapshot6)
  let snapshot7 ← readReg rvfi_mem_data
  let _ := print_bits "rvfi_mem_rmask: " (_get_RVFI_DII_Execution_Packet_Ext_MemAccess_rvfi_mem_rmask snapshot7)
  let snapshot8 ← readReg rvfi_mem_data
  let _ := print_bits "rvfi_mem_wdata: " (_get_RVFI_DII_Execution_Packet_Ext_MemAccess_rvfi_mem_wdata snapshot8)
  let snapshot9 ← readReg rvfi_mem_data
  let _ := print_bits "rvfi_mem_rdata: " (_get_RVFI_DII_Execution_Packet_Ext_MemAccess_rvfi_mem_rdata snapshot9)
  let snapshot10 ← readReg rvfi_mem_data
  let _ := print_bits "rvfi_mem_addr : " (_get_RVFI_DII_Execution_Packet_Ext_MemAccess_rvfi_mem_addr snapshot10)
  let snapshot11 ← readReg rvfi_int_data
  let _ := print_bits "rvfi_rd_wdata : " (_get_RVFI_DII_Execution_Packet_Ext_Integer_rvfi_rd_wdata snapshot11)
  let snapshot12 ← readReg rvfi_int_data
  let _ := print_bits "rvfi_rs2_data : " (_get_RVFI_DII_Execution_Packet_Ext_Integer_rvfi_rs2_rdata snapshot12)
  let snapshot13 ← readReg rvfi_int_data
  let _ := print_bits "rvfi_rs1_data : " (_get_RVFI_DII_Execution_Packet_Ext_Integer_rvfi_rs1_rdata snapshot13)
  let snapshot14 ← readReg rvfi_inst_data
  let _ := print_bits "rvfi_insn     : " (_get_RVFI_DII_Execution_Packet_InstMetaData_rvfi_insn snapshot14)
  let snapshot15 ← readReg rvfi_pc_data
  let _ := print_bits "rvfi_pc_wdata : " (_get_RVFI_DII_Execution_Packet_PC_rvfi_pc_wdata snapshot15)
  let snapshot16 ← readReg rvfi_pc_data
  let _ := print_bits "rvfi_pc_rdata : " (_get_RVFI_DII_Execution_Packet_PC_rvfi_pc_rdata snapshot16)
  let snapshot17 ← readReg rvfi_inst_data
  let _ := print_bits "rvfi_order    : " (_get_RVFI_DII_Execution_Packet_InstMetaData_rvfi_order snapshot17)
  pure ()
